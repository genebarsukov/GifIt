...
public class Camera2Basic {
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(@NonNull CameraDevice cameraDevice, int error) {
            ...
            cameraDevice.close();
            mCameraDevice = null;
            Log.d("CAMERA2 ERROR!", "CAMERA 2 onError !!! !!! !!!");
    ...
    private String temp_pic_file_path;
    /**
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            //   mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), mFile, fragment, front_camera_2));
            Image image_to_save = reader.acquireNextImage();
            ByteBuffer buffer = image_to_save.getPlanes()[0].getBuffer();
            byte[] bytes = new byte[buffer.remaining()];
            buffer.get(bytes);
            temp_pic_file_path = fragment.file_manager.saveTempPic(bytes);
        }
    ...
    public Camera2Basic(BaseFragment fragment) {
        this.fragment = fragment;
        this.front_camera_2 = false;
        this.mFile = new File(fragment.getActivity().getExternalFilesDir(null), "pic.jpg");
    }
    ...
    public void flipCamera() {
        ...
        if (mCameraId != null) {
            ...
            CameraManager camera_manager = (CameraManager) fragment.getSavedActivity().getSystemService(Context.CAMERA_SERVICE);
            try {
                camera_manager.openCamera(mCameraId, mStateCallback, mBackgroundHandler);
            } catch (CameraAccessException e) {
                e.printStackTrace();
            }
        }
     ...
     * If our Camera can autofocus, we use the autofocus trigger to take the pic
     * If autofocus is unavailable, we simply initiate the image capture
     */
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    fragment.getSavedActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            fragment.openDetailsFragment("workspace", String.valueOf(front_camera_2), temp_pic_file_path);
                        }
                    });
                }
            };
    ...
    private static class ImageSaver implements Runnable {
        ...
        private BaseFragment fragment;      /** The current fragment. Perorms interface actions */
        private Boolean front_camera_2;     /** Whether or not the front camera is selected */

        public ImageSaver(Image image, File file, BaseFragment fragment, Boolean front_camera_2) {
            this.mImage = image;
            this.mFile = file;
            this.fragment = fragment;
            this.front_camera_2 = front_camera_2;
        }
